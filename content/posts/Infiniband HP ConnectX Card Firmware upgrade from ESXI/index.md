...
Today I spent a couple hours trying to figure out why my 3rd host from previous blog "[Homelab – Upgrade Time!]({{< ref "Homelab Upgrade Time" >}})" won't connect to the Cisco SFS700D 20GB infiniband switch. vCenter (version 5.5.0 Update 2) was reporting the connection as down:
