...
In the previous [post]({{< ref "How to Edit Security Policies Apply them to Security Groups with PowerNSX" >}}), we discussed how to edit existing security policy using PowerNSX. We will round out this series by talking about how to remove NSX security policies with rules using PowerNSX.
